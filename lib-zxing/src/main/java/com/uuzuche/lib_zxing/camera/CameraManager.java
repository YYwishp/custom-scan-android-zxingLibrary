...
public final class CameraManager {
    ...
    public void openDriver(SurfaceHolder holder,boolean isAllScreen) throws IOException {
        mIsAllScreen = isAllScreen;
        if (camera == null) {
            camera = Camera.open();
            if (camera == null) {
            ...
            Log.e("SurfaceHolder的大小", holder.getSurfaceFrame().toString());
